...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_reschedule',
    download_url='https://github.com:nantic/trytond-stock_reschedule.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_reschedule.git'
    },
    classifiers=[
